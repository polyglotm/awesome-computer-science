...
// 9
calculationCount = 0;
function fibonacciBottomUpWithLinearIteration(n, iteration = 1, previous = 1, current = 1) {
    calculationCount++;
    if (iteration === n) {
        return current;
    }
    return fibonacciBottomUpWithLinearIteration(n, iteration + 1, current, previous + current);
}
